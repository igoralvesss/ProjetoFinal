<template>
          ...
          <div class="card-fed">
            ...
            <div class="descri-fed d-flex justify-end mt-6">
              <div class="btn-feed" color="black">
                <v-btn depressed color="deep-orange" class="white--text maior" @click="salvar" :disabled="!comente">Enviar</v-btn>
              </div>
            </div>
          </div>
        </v-col>
  ...
  >
    ...
    <v-card-actions class="d-flex justify-space-around">
      <v-btn depressed color="deep-orange" class="white--text mb-5" @click="salvar" :disabled="!comente">Enviar</v-btn>
    </v-card-actions>
  </v-card>
